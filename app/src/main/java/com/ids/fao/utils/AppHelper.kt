...
/*                .setCustomAnimations(
                    com.ids.fao.R.anim.enter_from_right,
                    com.ids.fao.R.anim.exit_to_left,
                    com.ids.fao.R.anim.enter_from_left,
                    com.ids.fao.R.anim.exit_to_right
                )*/
                .add(com.ids.fao.R.id.container, myFragment, myTag)
                .addToBackStack(null)
                .commit()
        }
        ...
        fun ReplaceFragment(fragmentManager: FragmentManager, selectedFragment:Int, myFragment: Fragment, myTag:String){
            ...
            fragmentManager.beginTransaction()
                ...
                .replace(com.ids.fao.R.id.container, myFragment, myTag)
                /*              .setCustomAnimations(
                                  com.ids.fao.R.anim.enter_from_right,
                                  com.ids.fao.R.anim.exit_to_left,
                                  com.ids.fao.R.anim.enter_from_left,
